...
<u>Месяц</u>
6. **Оплата картой и в кредит с использованием букв/спец. символов:**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
7. **Оплата картой и в кредит с одним значением:**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
8. **Оплата картой и в кредит со значением 00:**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
   ...
   *Ожидаемый результат:* Данные не отправлены. Отображается под полем "Месяц" сообщение "Неверный формат" 
9. **Оплата картой и в кредит со значением больше 12:**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
10. **Оплата картой и в кредит с использованием прошедшего месяца текущего года**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
11. **Оплата картой и в кредит с незаполненным полем "Месяц":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
<u>Год</u>
12. **Оплата картой и в кредит с использованием букв/спец. символов:** 
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
13. **Оплата картой и в кредит с одним значением:**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
14. **Оплата картой и в кредит со значением 00:**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
    ...
    *Ожидаемый результат:* Данные не отправлены. Отображается под полем "Год" сообщение "Неверный формат" 
15. **Оплата картой и в кредит с использованием прошедшего года:**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
16. **Оплата картой и в кредит с незаполненным полем "Год":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
<u>Владелец</u> 
17. **Оплата картой и в кредит с использованием спец. символов в поле "Владелец":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
18. **Оплата картой и в кредит с использованием кириллицы в поле "Владелец":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
19. **Оплата картой и в кредит с использованием латиницы в нижнем регистре в поле "Владелец":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
    ...
    *Ожидаемый результат:* Данные не отправлены. Отображается под полем "Владелец" сообщение "Неверный формат"
20. **Оплата картой и в кредит с использованием цифр в поле "Владелец":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
    ...
    *Ожидаемый результат:* Данные не отправлены. Поле не дает ввести другие символы. Отображается под полем "Владелец" сообщение "Поле обязательно для заполнения"
21. **Оплата картой и в кредит с незаполненным полем "Владелец":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
22. **Оплата картой и в кредит с использованием букв/спец. символов в поле "CVC/CVV":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
23. **Оплата картой и в кредит с использованием значений больше трех в поле "CVC/CVV":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
24. **Оплата картой и в кредит с использованием двух значений в поле "CVC/CVV":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
...
25. **Оплата картой и в кредит с незаполненным полем "CVC/CVV":**
    * Открыть страницу покупки тура.
    * Выбрать "Купить" или "Купить в кредит".
